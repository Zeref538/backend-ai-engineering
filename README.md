...
| [auth-api](auth-api/) | Sign up, log in, and a guard that stands in front of the protected routes. | BE-03 | Guard verified · Supabase round-trip is not |
...
54 checks in total, all passing as of 19 Sep 2026.

## What is honestly not finished

Four things need an account or an install I do not have, and every affected
...
- **Postgres (BE-04)** — written, never run. Docker is not installed. The
  ...
  ever started.
- **Supabase (BE-03)** — the guard is tested against a fake identity provider,
  including six different broken `Authorization` headers. The network call to
  Supabase has never run.
